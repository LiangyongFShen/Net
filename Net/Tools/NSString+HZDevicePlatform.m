...
@implementation NSString (HZDevicePlatform)

+ (NSString*) HZDevicePlatform
{
    size_t size;
    ...
    else if([platform isEqualToString:@"iPhone7,3"]||
            [platform isEqualToString:@"iPhone7,4"])
    {
        platform =
        @"iPhone 6 Plus";
    }
