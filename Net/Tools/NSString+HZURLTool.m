...
@implementation NSString (HZURLTool)
...
+ (NSString *)HZURLEscape:(NSString *)urlString
{
    ...
    NSInteger strLength = urlString.length;
    for (int i=0; i<strLength; i++) {
        int ch = [urlString characterAtIndex:i];
...
+ (NSString *)HZURLEncodeExceptSlash:(NSString*)string {
    ...
    string = [NSString HZURLEscape:string];
